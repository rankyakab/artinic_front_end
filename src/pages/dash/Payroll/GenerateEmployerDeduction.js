...
import { createEmployerDeduction } from '../../../redux/actions/EmployerAction';
import SuccessCard from '../../../components/SuccessCard';
import ErrorCard from '../../../components/ErrorCard';

const GenerateEmployerDeduction = () => {
  ...
  const handleEmployerDeduction = (e) => {
    e.preventDefault();
    console.log(data);
    dispatch(createEmployerDeduction(data, setOpen, setError, setErrorMessage, setSuccessMessage));
  };
  ...
  return (
    <>
      ...
      />
      <Helmet>
        <title> Generate Employer Deduction | Relia Energy</title>
      </Helmet>
      ...
      <Wrapper>
        ...
        <FormCard sx={{ mt: 4 }} onSubmit={handleEmployerDeduction}>
          <Title>Generate Employer Deduction</Title>
...
export default GenerateEmployerDeduction;
